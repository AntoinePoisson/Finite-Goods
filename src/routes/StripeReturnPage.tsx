...
export function StripeReturnPage() {
  ...
  useEffect(() => {
    ...
    // A redirect is recorded for visibility, but it cannot move an order to PAID.
    void store
  ...
  return (
    <section className='return-page'>
      ...
      <p>
        The browser came back from checkout, but this static site cannot receive or verify a Stripe webhook.
        The order remains explicitly unverified.
      </p>
