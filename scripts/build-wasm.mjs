...
// Keep Go's caches inside the repository so local and CI builds use the same writable paths.
...
// Go 1.24 moved the browser runtime; support both locations for local contributors.
