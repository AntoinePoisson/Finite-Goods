...
/** shape the github action expects */
...
// median of the repeats so one noisy CI run doesnt look like a regression
...
// playwright loads this from the config, dont import it from a spec
