...
export default [
  {
    // Only the generated WebAssembly glue is ignored; public/wasm/engine.worker.js is source.
  ...
  },
  {
    files: ['public/**/*.js'],
    languageOptions: {
      // `Go` is injected by the generated wasm_exec.js glue loaded via importScripts.
